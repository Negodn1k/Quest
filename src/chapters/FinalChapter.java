...
public class FinalChapter extends SecondChapter {
    ...
    public static void go() {
        try {
            ...
            System.out.println("Оставшись под впечатлением, Ержан пошёл дальше уже по тропинке, \n" +
                ...
                switch (firstChoice) {
                    case (2):
                        ...
                        while (secondChoiceCheck) {
                            ...
                            switch (secondChoice) {
                                case (2):
                                    System.out.println("Ержан заказал бургер. Ему его приготовили и он принялся его поглощать." +
                                    ...
                                    break;
                                case (1):
                                    System.out.println("Он заказал шаурму. Ему её приготовили и он принялся её поглощать." +
                                            "\nПочувствовав вкус шаурмы, Ержан проснулся у себя дома и понял что это был всё сон. " +
                        ...
                        break;
                    case (3):
                        System.out.println("Голод взял верх над главным героем и он пошёл на рынок." +
                                "\nТам он увидел заведение Аль-шарк, но там был скудный выбор." +
                                "\nБыли лишь шаурма и бургеры ");                // Развитие сюжета после первой развилки(второй выбор)
                        firstChoiceCheck = false;
                        writer.write("Третья глава\nПервый выбор:");
                        ...
                        break;
                    case (1):
                        System.out.println("Ержан не стал доверять указателю и решил спросить дорогу у стражников." +
